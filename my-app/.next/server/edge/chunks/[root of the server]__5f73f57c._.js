(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__5f73f57c._.js", {
...
;
;
const JWT_SECRET = ("TURBOPACK compile-time value", "mysecretkey");
...
function middleware(req) {
    ...
    if (pathname.startsWith("/signup/adminlogin")) {
        ...
        try {
            const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].verify(adminToken, JWT_SECRET);
    ...
    if (pathname.startsWith("/signup/userlogin")) {
        ...
        try {
            const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].verify(userToken, JWT_SECRET);
            if (decoded.role === "admin") {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5f73f57c._.js.map